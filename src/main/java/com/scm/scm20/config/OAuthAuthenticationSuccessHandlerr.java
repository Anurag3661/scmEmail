...
@Component
public class OAuthAuthenticationSuccessHandlerr implements AuthenticationSuccessHandler {

    Logger logger = LoggerFactory.getLogger(OAuthAuthenticationSuccessHandlerr.class);
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        logger.info("OAuthAuthenticationSuccessHandlerr");
